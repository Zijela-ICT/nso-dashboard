                    ...
                    {results.length === 0 ? (
                        ...
                        <Badge variant={getScoreColor(result.totalScore)}>
                          {result.totalScore}%
                                            ...
                                            <TableCell>
                                                {(() => {
                                                    const end = new Date(result.assessment.endDate).getTime();
                                                    const isInProgress = end > Date.now();
                                                    return (
                                                        <Badge variant={isInProgress ? "pending" : "success"}>
                                            ...
                                            <TableCell>
                                                {formatToLocalTime(result.assessment.startDate)}
                                            </TableCell>
                                            <TableCell>
                                                {formatToLocalTime(result.assessment.endDate)}
                                            </TableCell>
                                            {/*<TableCell>*/}
                                            {/*    {(() => {*/}
