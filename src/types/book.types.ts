...
export interface Linkable {
  type: 'linkable';
  content: { text: string; linkTo?: string; linkType: 'internal' | 'external'; textStyle?: object }[];
  style?: object;
}
...
//   type: 'decision',
//   history: ['How long has the child been vomiting? How often?', 'Is it associated with eating?'],
...
//     'Lethargic',
//   ],
//   healthEducation: ['give your child your succulent breast to drink. What are you doing with it?'],
//   cases: [
//     {
//       findingsOnExamination: [
//         'Neck stiffness',
...
//         'Lethargic',
//       ],
//       clinicalJudgement: 'Severe condition. Suspect Meningitis',
//       actions: [
//         'Give Benzyl penicillin double dose stat',
//         '2 months to 11 months (300mg stat)',
//         '12 months to 5 years (600mg stat)',
//         'REFER immediately to the appropriate health facility.',
//         'If referral is difficult, repeat 6 hourly till you get to hospital.',
//       ],
//     },
//     {
//       findingsOnExamination: ['Mild dehydration'],
//       clinicalJudgement: 'Mild condition',
//       actions: ['Follow plan A for diarrhea treatment'],
//     },
//   ],
// };
